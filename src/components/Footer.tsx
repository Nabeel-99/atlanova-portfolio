  ...
  return (
    <footer className="w-full h-full  px-4 mt-2">
      <div className="bg-black flex flex-col gap-4 p-6 lg:p-10 lg:px-20 rounded-lg text-white ">
        <div className="flex flex-col 2xl:container 2xl:mx-auto items-start md:flex-row md:justify-between gap-10 border-b border-white/20 pb-10 lg:gap-20 w-full">
          ...
          <div className="flex flex-col gap-3">
            ...
            <ul className="grid grid-cols-2   gap-4 lg:gap-x-24 text-lg text-white/80">
              <li>
